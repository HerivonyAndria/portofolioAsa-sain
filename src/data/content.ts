...
export const homeIntroConfig = {
   ...
   */
  introParagraphs: [
    "Expert IT avec plus de 6 ans d'expérience dans l'administration système, la virtualisation et le cloud. Actuellement Freelance IT à travers ma société ASA-SAÏN, spécialisée dans l'externalisation de services informatiques, l'administration système et le monitoring.",
